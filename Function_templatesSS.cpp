...
void count_elements(const std::vector<int>& arr, int& positive, int& negative, int& zero) {
...
int main() { 
    ...
    std::vector<int> numbers = {1, -2, 3, 0, -5, 6, 0, -1};
    std::cout << "Середнє арифметичне: " << average(numbers) << std::endl;
    
    int positive, negative, zero;
    count_elements(numbers, positive, negative, zero);
    std::cout << "Додатних: " << positive << ", Від'ємних: " << negative << ", Нулів: " << zero << std::endl;
